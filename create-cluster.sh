...
helm install $1 mysql-chart --atomic --set replicaCount=$2 --set mysql.user_password=$4 --set mysql.root_pass=$4 --set mysql.repl_pass=$4 --set mysql.user=$3 --set mysql.user_database=$5 --timeout 30m0s
